...
export default function Tests() {
  ...
  const filteredPastTests = pastTests.filter(
    (test) =>
      test.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
      test.description.toLowerCase().includes(searchQuery.toLowerCase()) ||
      test.course.toLowerCase().includes(searchQuery.toLowerCase())
  ...
  const renderTestMode = () => {
    ...
    const progress =
      ((currentQuestionIndex + 1) / sampleTest.questions.length) * 100;
      ...
      <div className="pb-8 max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-center">
            <h2 className="text-xl font-semibold">{sampleTest.title}</h2>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-8 mb-8">
          ...
          {currentQuestion.type === "multiple_choice" && (
            ...
            >
              {currentQuestion.options?.map((option, index) => (
                <div
                  key={index}
                  className="flex items-center space-x-3 border border-gray-200 rounded-lg p-4 hover:bg-gray-50"
                >
          ...
          {currentQuestion.type === "true_false" && (
            <RadioGroup
              ...
              onValueChange={(value) =>
                handleAnswerSelection(currentQuestion.id, value === "true")
              }
              className="space-y-3"
            >
